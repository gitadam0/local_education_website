...
<h2 class="row  my-5 justify-content-center  ">COURSES</h2>
...
<div id="carouselExampleIndicators" class="carousel slide w-50" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="views/zeldaimg.jpg" class="d-block w-100" alt="...">
    </div>
...
<div class="container">
    ...
    <img src="views/zeldaimg.jpg" class="card-img-top" alt="h">
    <div class="card-body">
